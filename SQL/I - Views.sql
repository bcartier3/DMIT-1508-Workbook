...
--
-- The advatage of using a view are:
-- 1) The It's a way of "saving" our query on the database
-- 2) A view can, itself, be used in a FROM clause
-- 3) Because it's a "stored" query on the database, the database engine can perform some "optimizations" to make it run quickly
